...
class RouteTest {
    ...
    void Route(){
        ...
        assertThrows(IllegalArgumentException.class, () -> new Route("", "", "", "", "",
                "", "", "", "", "", "",
                ""));
    ...
    void getRouteID() {
        ...
        //Makes sure route_id cannot be empty
        assertThrows(IllegalArgumentException.class, () -> test_route = new Route("", agency_id, route_short_name, route_long_name, route_desc, route_type,
                route_url, route_color, route_text_color, route_sort_order, continuous_pickup, continuous_drop_off));
    }
