...
class StopTimesTest {
    ...
    void validateHeader() {
        ...
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader(""));

        //throw exception if input line does not contain trip_id
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("arrival_time,departure_time,stop_id,stop_sequence,stop_headsign,pickup_type,drop_off_type"));

        //throw exception if input line does not contain stop_id
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("trip_id,arrival_time,departure_time,stop_sequence,stop_headsign,pickup_type,drop_off_type"));

        //throw exception if input line does not contain stop_sequence
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("trip_id,arrival_time,departure_time,stop_id,stop_headsign,pickup_type,drop_off_type"));

        //throw exception if input line contains a blank header at start or middle
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader(",trip_id,arrival_time,departure_time,stop_id,stop_sequence,stop_headsign,pickup_type,drop_off_type"));
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("trip_id,arrival_time,departure_time,stop_id,stop_sequence,stop_headsign,pickup_type,drop_off_type, "));
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("trip_id,arrival_time,departure_time,stop_id,,stop_sequence,stop_headsign,pickup_type,drop_off_type"));

        //throw exception if input line contains an extra (unexpected) header
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("trip_id,arrival_time,departure_time,stop_id,stop_sequence,stop_headsign,pickup_type,drop_off_type,extra_header"));
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("extra_header,trip_id,arrival_time,departure_time,stop_id,stop_sequence,stop_headsign,pickup_type,drop_off_type"));
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateHeader("trip_id,arrival_time,departure_time,stop_id,stop_sequence,extra_header,stop_headsign,pickup_type,drop_off_type"));
    ...
    void validateData() {
        //throw exception if input line is empty
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateData("", new Headers()));

        //throw exception if data line field amount does not match header field amount
        assertThrows(IllegalArgumentException.class, () -> stopTimes.validateData("0,0,0", expectedHeaders));
