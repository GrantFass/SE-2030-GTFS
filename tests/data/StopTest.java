...
class StopTest {
    ...
    void Stop(){
        ...
        assertThrows(IllegalArgumentException.class, () -> new Stop("", "","","",
                "","","","","","",
        "","", ""));
        // check that no exception is thrown with all valid data
        assertDoesNotThrow(() -> {
            new Stop("test", "0", "test", "test",
                    "test", "test", "6712", "43.0444475", "-87.9779369",
                    "STATE & 5101 #6712", "CST", "https://www.google.com/",
                    "0");
        });
        // check if exception is thrown with stop_id missing
        assertThrows(IllegalArgumentException.class, () -> new Stop("test", "0", "test", "test",
        ...
        assertThrows(IllegalArgumentException.class, () -> new Stop("test", "test", "test", "test",
               "test", "test", "6712", "43.0444475", "-87.9779369",
               "STATE & 5101 #6712", "CST", "https://www.google.com/",
               "0"));
